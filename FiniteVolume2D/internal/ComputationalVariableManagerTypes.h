...
public:
    ...
    typedef std::function<bool (IComputationalGridAccessor const & cgrid, std::shared_ptr<ComputationalCell> const & cell, std::shared_ptr<ComputationalFace> const & face)> FluxEvaluator_t;
